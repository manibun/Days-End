...
MoreBuild.onBuildHighMetalFence = function(ignoreThisArgument, sprite, player, name)
  ...
  _metalFence.modData['use:Base.Wire'] = 1
  _metalFence.modData['need:Base.MetalBar'] = 5
  _metalFence.modData['need:Base.ScrapMetal'] = 20
  _metalFence.modData['use:Base.WeldingRods'] = 1
  _metalFence.modData['use:Base.BlowTorch'] = 5
