...
TweakItem("CanteensAndBottles.CanteenOliveDrabFull","DisplayCategory","Junk");
TweakItem("CanteensAndBottles.CanteenArmyGreenFull","DisplayCategory","Junk");
TweakItem("CanteensAndBottles.FlaskFull","DisplayCategory","Junk");
TweakItem("CanteensAndBottles.FlaskSpiffoFull","DisplayCategory","Junk");
TweakItem("CanteensAndBottles.GymBottleBlueYellowFull","DisplayCategory","Junk");
TweakItem("CanteensAndBottles.GymBottleOrangeCharcoalFull","DisplayCategory","Junk");
TweakItem("CanteensAndBottles.GymBottlePurpleGreyFull","DisplayCategory","Junk");
TweakItem("CanteensAndBottles.GymBottleSpiffoFull","DisplayCategory","Junk");
end
